...
const Footer: React.FC = () => {
  ...
  return (
    <footer
      style={{ borderTop: "1px solid var(--line)", padding: "56px 0 28px" }}
    >
      <div
      ...
      >
        ...
        <div>
          ...
          <FooterLink to="/products/softy-layouts">
            SOFTY Custom Layouts
          </FooterLink>
      ...
      <div
        className="container"
        style={{ marginTop: 40, fontSize: 12.5, color: "var(--slate-soft)" }}
      >
